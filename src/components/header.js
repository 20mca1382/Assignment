  ...
  return (
    <div className="absolute w-full top-[0px] right-[0%] left-[0%] h-[60px] text-left text-base text-lightslategray font-headline-h52">
      ...
      <img
        ...
        src="../option.svg"
      />
      <div className="absolute top-[calc(50%_-_11px)] left-[84px] text-3xl font-archivo text-black inline-block w-[161px]">
        WASSERSTOFF
      </div>
      <img
        className="absolute top-[10px] left-[35px] w-10 h-10 overflow-hidden"
        alt=""
        src="../wstflogo-1.svg"
      />
    </div>
